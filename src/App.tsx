...
function WizardManager() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] font-sans text-slate-800">
      {/* Header */}
      <header className="bg-white border-b border-slate-200 px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-center justify-between sticky top-0 z-10 shadow-sm gap-4 sm:gap-0">
        <h1 className="text-base sm:text-xl font-medium tracking-tight text-slate-900 text-center sm:text-left leading-tight">
          个人构念心理评估
          <span className="block sm:inline sm:ml-2 text-sm sm:text-base text-slate-500 font-normal">
            (Personal Construct Assessment)
          </span>
        </h1>
        <div className="flex space-x-1 sm:space-x-2 text-sm text-slate-500 overflow-x-auto w-full sm:w-auto pb-1 sm:pb-0 hide-scrollbar">
          {[
            "主题设定",
            "确立元素",
            "提取构念",
